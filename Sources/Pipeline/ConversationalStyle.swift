...
enum ConversationalStyle {
    ...
    private static let endings: [(String, String)] = [
        ...
        // 자주 새는 존댓말 종결 → 반말 (문장 끝 특정 패턴이라 안전)
        ("부탁드립니다", "부탁해"), ("부탁드려요", "부탁해"), ("부탁할게요", "부탁할게"),
        ("수고하셨습니다", "수고했어"), ("수고하셨어요", "수고했어"), ("하셨습니다", "했어"), ("하셨어요", "했어"),
        ("하겠습니다", "할게"), ("하겠어요", "할게"), ("드리겠습니다", "줄게"),
        ("쉬세요", "쉬어"), ("하세요", "해"), ("가세요", "가"), ("오세요", "와"),
        ("주세요", "줘"), ("보세요", "봐"), ("드세요", "먹어"), ("계세요", "있어"), ("기다리세요", "기다려"),
    ]
